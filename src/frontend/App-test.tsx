      ...
      <div style={{
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
          <li style={{ marginBottom: '0.8em', fontSize: '1.1em' }}>
            ✅ Frontend React: <span style={{ fontWeight: 'bold' }}>Funcionando en http://localhost:5174</span>
          </li>
          <li style={{ marginBottom: '0.8em', fontSize: '1.1em' }}>
            ✅ Backend API: <span style={{ fontWeight: 'bold' }}>Funcionando en http://localhost:3001</span>
          </li>
          <li style={{ marginBottom: '0.8em', fontSize: '1.1em' }}>
            ✅ Base de Datos: <span style={{ fontWeight: 'bold' }}>Conectada (simulada en memoria)</span>
          </li>
        </ul>
        <button style={{
          marginTop: '2em',
